...
__asm(
    ...
    "gadget_2:                                  \n" // Copy dereferenced value of rbx to rcx
    "       mov rcx, qword ptr [rbx]            \n"
    "       ret                                 \n"

    "gadget_3:                                  \n" // Copy r8 - r10 to rax - rcx
    "       mov rax, r8                         \n"
    "       mov rbx, r9                         \n"
    "       mov rcx, r10                        \n"
    "       ret                                 \n"

    "gadget_4:                                  \n" // XOR rcx with rdi and XOR rbx with rdi
    "       xor rcx, rdi                        \n"
    "       xor rbx, rdi                        \n"
    "       ret                                 \n"
    ...
    "gadget_7:                                  \n" // Substract 8 from rax and divide rax by rdi
    "       sub rax, 0x8                        \n"
    "       idiv rdi                            \n"
    "       ret                                 \n"
    ...
    "gadget_12:                                 \n" // Add r10 and rsi, save to rcx
    "       mov rcx, rsi                        \n"
    "       add rcx, r10                        \n"
    "       ret                                 \n"

    "gadget_13:                                 \n" // XOR rdi with rcx and XOR rsi with rcx
    "       xor rdi, rcx                        \n"
    "       xor rsi, rcx                        \n"
    "       ret                                 \n"

    "gadget_14:                                 \n" // Push rdi onto stack as second
    "       pop rbx                             \n"
    "       push rdi                            \n"
    "       push rbx                            \n"
    "       ret                                 \n"

    "gadget_15:                                 \n" // Pop two stack values into rbp and rsi
    "       pop rbp                             \n"
    "       pop rsi                             \n"
    "       ret                                 \n"
