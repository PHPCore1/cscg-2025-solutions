var System = new (function () {
  ...
  function k(b) {
    0 < arguments.length
      ? ((this.pagePos = new g(b.pagePos)),
        (this.mousePos = new g(b.mousePos)),
        (this.mouseMov = new g(b.mouseMov)),
        (this.mouseWheel = b.mouseWheel),
        (this.mouseButton = b.mouseButton),
        (this.keyCode = b.keyCode),
        (this.charCode = b.charCode),
        (this.ctrlPressed = b.ctrlPressed),
        (this.altPressed = b.altPressed),
        (this.shiftPressed = b.shiftPressed))
      : ((this.pagePos = new g()),
        (this.mousePos = new g()),
        (this.mouseMov = new g()),
        (this.charCode = this.keyCode = this.mouseWheel = this.mouseButton = 0),
        (this.shiftPressed = this.altPressed = this.ctrlPressed = !1));
  }
  function f(b) {
  ...
  function a() {
    if (u) {
      ...
      var a = function (a) {
        try {
          f(a),
            (m.mouseWheel = 0 < (a.detail ? a.detail : -a.wheelDelta) ? 1 : -1),
            b.phase.mouseWheel(m);
        } catch (d) {}
        a.preventDefault();
      };
      ...
      window.addEventListener(
        ...
        function (a) {
          ...
          void 0 != a.movementX
            ? ((m.mouseMov.x = a.movementX), (m.mouseMov.y = a.movementY))
            : void 0 != a.mozMovementX
            ? ((m.mouseMov.x = a.mozMovementX), (m.mouseMov.y = a.mozMovementY))
            : void 0 != a.webkitMovementX &&
              ((m.mouseMov.x = a.webkitMovementX),
              (m.mouseMov.y = a.webkitMovementY));
  ...
  function c(a) {
    ...
    try {
      b.phase !== oldPhase &&
        (null !== oldPhase && oldPhase.end(),
        null != b.phase &&
          (b.phase.begin(oldPhase), (oldPhase = b.phase), b.phase.wake())),
        null != b.phase && b.phase.update(d);
    } catch (e) {
      b.err("mainLoop()", e);
    }
  }
  ...
  b.onInit = function (a) {
    r
      ? b.err("Function not added via onInit(), already initialized")
      : p.push(a);
  };
  b.start = function (d) {
    if (null != v)
      return b.err("start() called while engine is already running."), !1;
    v = { realtime: !0, canvas: "viewport" };
    if ("undefined" != typeof d && null != d)
      try {
        (v.realtime = d.realtime ? !0 : !1),
          "undefined" != typeof d.canvas && (v.canvas = d.canvas);
      } catch (c) {
  ...
  A = window.setInterval(function () {
    try {
      ...
      n &&
        d &&
        (window.clearInterval(A), (A = null), (u = !0), null != v && a());
    } catch (c) {
...
new (function () {
  ...
  k.LinkedList = function () {
    ...
    this.attach = function (e) {
      null == f
        ? ((f = e.first()), (a = e.last()))
        : ((a.next = e.first()),
          null != a.next && ((a.next.prior = a), (a = e.last())));
      e.empty();
    };
  };
  k.LCPRNG = function (f, a) {
    ...
    e.seed = function (l) {
      if (0 < arguments.length) {
        c[0] = f = l | 0;
        for (var g = a - 1, d = 1; d < g; ++d)
          c[d] = (16807 * c[d - 1]) & 2147483647;
        c[g] = c[0];
        c[0] = c[1];
        c[1] = c[2];
        b = 2;
  ...
  k.Box3 = function (f, a, e, c, b, l) {
    var n = this;
    5 <= arguments.length
      ? ((n.a = new g(f, a, e)), (n.b = new g(c, b, l)))
      : 1 < arguments.length
      ? ((n.a = new g(f)), (n.b = new g(a)))
      : 1 == arguments.length
      ? ((n.a = new g(f.a)), (n.b = new g(f.b)))
      : ((n.a = new g()), (n.b = new g()));
    this.toString = function () {
      return "{a:" + n.a + ",b:" + n.b + "}";
    };
  ...
  g.AssetManager = function (f) {
    ...
    a.storeAll = function (b, c, d) {
      ...
      for (g in e) {
        var h = e[g];
        null == h ||
          (b && "function" == typeof h.updated && !h.updated()) ||
          (++f, a.store(h, c, d));
      }
      return f;
    };
    a.store = function (a, b, d) {
      if (d) {
        g.log(
          "Error: AssetManager.store(): Remote storage unimplemented.",
          "#911"
        );
        try {
          b(a, 0);
    ...
    a.fetch = function (a, k, d) {
      ...
      if (p) {
        try {
          ...
          return (
            g.log("AssetManager callback error '" + f + a + "': " + r, "#911"),
            -1
          );
        }
        return 0;
          ...
          if (null == d)
            for (var h in u)
              try {
                ...
                g.log(
                  "AssetManager callback error '" + f + a + "': " + k,
                  "#911"
                );
              }
          else {
            if (d.type) {
              ...
              if (n)
                try {
                  ...
                  g.log(
                    "AssetManager creation error '" + f + a + "': " + p,
                    "#911"
                  );
                  for (h in u)
                    try {
                      ...
                      g.log(
                        "AssetManager callback error '" + f + a + "': " + G,
                        "#911"
                      );
                    }
                  delete c[a];
            ...
            for (h in u)
              try {
                ...
                g.log(
                  "AssetManager callback error '" + f + a + "': " + T,
                  "#911"
                );
              }
          }
      ...
      if (localStorage && ((p = localStorage.getItem(a)), null != p))
        try {
          return v(eval(p)), 1;
        } catch (A) {
          g.log(
            "AssetManager localStorage eval() error '" +
              a +
              "': " +
              A +
              "\\n" +
...
new (function () {
  ...
  k.Machine = g;
  Math.imul ||
    (Math.imul = function (a, e) {
      var c = a & 65535,
        b = e & 65535;
      return (
        (c * b +
          (((((a >>> 16) & 65535) * b + c * ((e >>> 16) & 65535)) << 16) >>>
            0)) |
        0
      );
    });
  ...
  k.Environment = function () {
    ...
    function l(b) {
      if ("number" == typeof b)
        return 0 < b
          ? (k.log("sc error " + b + ", 0x" + b.toString(16) + ": " + a(b)), b)
          : b - 1;
      k.log("sc error ?: " + a(b));
      k.log(b);
      return A;
    ...
    function u(a) {
      ...
      this.brain = new Function("std", "foriegn", "heap", f)(
        window,
        { error: e, imul: Math.imul, logs: n, logv: d, wait: p, time: r },
        b
      );
      this.size = a;
      this.heap = b;
    ...
    var v = 6,
      A = 7,
      m =
        "OK.;Permission Required.;Out of memory.;Invalid operation.;Invalid memory access.;Invalid access alignment.;Unknown error.;Host environment exception.;Halted.;Operation not supported.".split(
          ";"
        ),
      s = void 0;
    this.LSB = s;
...
new (function () {
  var h = System,
    g =
      "#000 #00a #0a0 #0aa #a00 #a0a #a50 #aaa #555 #55f #5f5 #5ff #f55 #f5f #ff5 #fff".split(
        " "
      ),
    k =
      "#000000 #000084 #008400 #008080 #840000 #800080 #804000 #808080 #404040 #4040ff #38ff38 #40ffff #ff4040 #ff40ff #ffff40 #ffffff".split(
        " "
      ),
    f =
      "#000000 #000099 #009900 #009292 #9b0000 #940094 #964b00 #939393 #4b4b4b #4c4ce0 #39e339 #40e2df #e34b4b #e34ae3 #e0e048 #e2e2e2".split(
        " "
      );
  ...
  h.TextDisplay = function (a, e, c, b, l) {
    ...
    d.setScanLines = function (a) {
      ...
      n(K[1], l ? k : g);
      l && 1 < b
        ? ((viewport.parentElement.style.backgroundColor = f[E]), (D = k))
        : ((viewport.parentElement.style.backgroundColor = g[E]), (D = g));
      s = 1 < b ? u.ctx : m;
    ...
    d.render = function () {
      if (U) {
        ...
        if (0 != (q & 1610612736)) {
          ...
          v = ((k + n * w) >> 1) + G;
          (0 != (q & 268435456)) != l
            ? ((E = t), d.setScanLines(q & 268435456))
            : t != E &&
              ((E = t),
          ...
          s.globalAlpha = 1;
          for (
            var z = (t = 0), y = 0, x = 0, S = 0, O = 0, P = 0, K = 0, y = G;
            y <= T;
            ++y
          ) {
            x = B[y];
            if (x == R[K] && y != v && y != A) {
              if ((++K, (t += 9), t >= e && ((z += 16), (t = 0), z >= c)))
                break;
            } else {
              R[K++] = x;
              O = (x >> 8) & 15;
          ...
          F &&
            ...
            9 > H &&
              ...
              16 < L + J && (J = 16 - L),
              (s.fillStyle = D[O]),
              s.fillRect(9 * k + H, (n << 4) + L, I, J)));
          1 < b &&
            (h.scaleSmoothing(m, !1),
            (m.globalAlpha = 1),
            (m.globalCompositeOperation = "source-over"),
            m.drawImage(u, 0, 0, e, c, 0, 0, p, r),
            l &&
              null != X &&
              ((m.fillStyle = X),
              m.fillRect(0, 0, p, r),
              (m.globalCompositeOperation = "lighter"),
              h.scaleSmoothing(m, !0),
              (m.globalAlpha = 0.5),
              m.drawImage(a, 0, 0, p, r, 1.5, 0, p, r),
              m.drawImage(a, 0, 0, p, r, -0.25, 1, p, r)));
          B[0] = q;
        }
      }
    };
    ...
    try {
      ...
      var e = document.getElementById("viewport"),
        ...
        b = new h.InputDevice(function (a) {
          c ||
            (0 <= a && ((cycleDelay = -g.cycle(k, 32768)), l.render()),
            0 > cycleDelay && (c = !0));
        }),
        l;
      1440 <= e.offsetParent.offsetWidth + 4 &&
      800 <= e.offsetParent.offsetHeight + 4
        ? ((l = new h.TextDisplay(e, 720, 400, 2, !1)), b.setScale(1))
        : ((l = new h.TextDisplay(e, 720, 400, 1, !1)), b.setScale(2));
      ...
      var p = (a.pos + a.size + 1023) & 268434432,
        f = [
          363017, 0, 231945, 80, 33587721, 33293, 65536, 395785, 16809992,
          33291, 19316, 17072659, 557594, 160, 67633677, 135037459, 786441,
          201865481, 32, 1077257, 1081354, 295435, 17480, 68420105, 135791113,
          203162121, 295455, 17452, 33293, 1, 295437, 1, 33291, 17484, 33289,
          64, 291337, 295442, 536870912, 67140105, 32, 33289, 19424, 295433, 28,
          557577, 9, 819721, 15, 33311, 17484, 33289, 19496, 295433, 28, 557577,
          15, 819721, 15, 33311, 17484, 33291, 17544, 33289, 19440, 295433, 28,
          557577, 11, 819721, 19364, 202142217, 33311, 17484, 33289, 19468,
          295433, 28, 557577, 13, 819721, 19364, 202142217, 33311, 17484, 33289,
          179, 295433, 28, 557577, 12, 819721, 19364, 202142217, 33311, 17452,
          33289, 179, 295433, 51, 557577, 12, 819721, 19364, 202142217, 33311,
          17452, 33289, 19376, 295433, 29, 557577, 12, 819721, 19364, 202142217,
          33311, 17484, 33289, 19372, 64010, 22, 295435, 17952, 295433, 29,
          291341, 33289, 32, 557577, 12, 819721, 19364, 202142217, 33311, 17452,
          33289, 19368, 29193, 295433, 53, 557577, 12, 819721, 19364, 202142217,
          33311, 17452, 33291, 17544, 33289, 19364, 64009, 15, 33289, 19368,
          64009, 32, 33289, 70, 63753, 12, 32, 33289, 19372, 64010, 22, 1606155,
          18760, 33289, 19376, 295433, 19400, 553993, 558096, 557011812,
